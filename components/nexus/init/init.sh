...
# http://192.168.49.2:30000/service/rest/v1/repositories/docker/hosted/nexus-dan-docker-release-http
# curl -s -o /dev/null -u admin:admin -w "%{http_code}" "${NEXUS_API_BASE_PATH}/v1/repositories/docker/hosted/nexus-dan-docker-release-http"
# curl -s -o /dev/null -u admin:admin -w "%{http_code}" http://192.168.49.2:30000/service/rest/v1/repositories/docker/hosted/nexus-dan-docker-release-http
