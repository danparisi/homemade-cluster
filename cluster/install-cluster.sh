...
my_helm3 upgrade --install -n "${NAMESPACE}" prometheus-adapter prometheus-community/prometheus-adapter -f "$PROJECT_DIRECTORY/components/prometheus-adapter/helm/prometheus-adapter-values.yaml"
